...
走读完成后，将整个走读过程总结到一个 markdown 文件中，方便用户后续回顾。

**文件命名**：`walkthrough-{主题}-{日期}.md`

例如：`walkthrough-message-flow-2026-05-13.md`

**文件存放位置**：在当前工作目录下创建 `walkthrough/` 目录存放
...
**触发时机**：用户确认走读完成时（如说"走读完成"、"结束"），或在总结阶段主动询问是否需要生成记录。
